  ...
  return (
    <>
      <footer
        style={{
          backgroundImage:
            "url(https://i.ibb.co/9Zk5QbJ/beakers-for-science-with-water.jpg)",
        }}
        className="rounded-t-3xl divide-y mt-20 bg-bottom bg-fixed bg-cover bg-no-repeat text-white "
      >
        <div className="bg-black bg-opacity-80 px-10 pt-12 pb-7 rounded-t-3xl">
          <div className="flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div className="lg:w-1/3 text-center">
              ...
              <a className="btn btn-ghost text-3xl font-bold">DiagPulse</a>
