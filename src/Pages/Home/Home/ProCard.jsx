...
const ProCard = ({ pro }) => {
  ...
  return (
    <div>
      <div className="card bg-base-100 h-full rounded-[7px] hover:bg-[#0F2976] hover:text-white group transition-all duration-400">
        <div className="card-body relative overflow-hidden rounded-[7px]">
          ...
          <div className="flex-grow ">
            <h3 className="font-semibold text-[#0F2976] group-hover:text-white">{title}</h3>
            ...
            <p className="text-[15px]">
              <span className="text-[#0F2976] font-bold group-hover:text-white">Date :</span> {dates}
            </p>
          </div>
          <div className="-mb-2">
