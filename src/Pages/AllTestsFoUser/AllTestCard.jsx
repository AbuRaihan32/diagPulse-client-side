      ...
      <div className="card h-full rounded-[7px] bg-gray-50 hover:bg-[#0F2976] hover:text-white rounded-br-[100px] group transition-all duration-400">
        <div className="card-body relative">
          <p
            ...
            className="absolute text-xs right-4 top-4 py-1 px-2 rounded-full bg-gray-100 text-gray-500 group-hover:bg-[#0F2976] transition-all duration-400"
          >
            Booked {bookedCount ? bookedCount : 0}
          </p>
          <div
            data-aos="fade-right"
            data-aos-easing="linear"
            data-aos-duration="800"
            className="mask mask-hexagon w-36 h-36 flex justify-center items-center bg-gradient-to-r from-[#25BCCF] to-[#2EE9B1] mx-auto "
          >
